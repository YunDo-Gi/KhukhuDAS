...
export default class SoccerRoom extends Room
{
    ...
    removeObjects()
    {
        ...
        {
            if(child.name == 'Cylinder1' || child.name == 'Cylinder2' || child.name == 'Cylinder3' ||
               child.name == 'Cylinder4' || child.name == 'Cylinder5' || child.name == 'Cylinder6' ||
               child.name == 'Cylinder10' || child.name == 'Cylinder11' || child.name == 'Cylinder12' ||
               child.name == 'Cylinder13' || child.name == 'Cylinder14' || child.name == 'Cylinder15' || 
               child.name == 'Cylinder20' || child.name == 'Cylinder9' || child.name == 'Cube8' || child.name == 'Sphere2')
            {
